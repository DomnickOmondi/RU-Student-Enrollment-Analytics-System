...
<head>
    ...
    <title>Course Enrollment - Rongo Universiy Students Enrollment Analytics MIS</title>
...
<body>
    <nav>
        ...
        <button><a href="enrollment_form.php">admin</a></button>
    ...
    <h1 class="header">Analytics for student course enrollment per semester goes here</h1>
